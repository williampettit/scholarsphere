        ...
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;This site has saved me countless hours of work and helped
                me remember all of my assignments' due dates better than any
                other system I have tried before.&rdquo;
              </p>
